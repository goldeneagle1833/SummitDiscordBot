...
KNOWN_PUBLIC_ENDPOINTS = {
    ...
    "api.avatars.get_season_avatar_badges",  # top player per avatar only, no win rates
    ...
    "api.brackets.get_bracket_marks",
    "api.brackets.get_player_postseason",
    ...
    "api.events.get_event_match_history",
    ...
    "api.match_reporting.edit_match_time",
    "api.match_reporting.auto_confirm_match",
