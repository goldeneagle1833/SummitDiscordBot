...
function FartAdmin({ data, onRefresh }) {
  ...
  const handleReset = async () => {
    if (!confirm('Reset the entire fart game / season? This clears ALL scores, history, cooldowns, Evil Star locks, donation history, and star protection. This cannot be undone.')) return
    setLoading(true)
    try {
        ...
        <div className="space-y-4">
          <div className="p-3 border border-border rounded-lg">
            ...
            <p className="text-xs text-text-muted mb-3">
              Clear all fart scores, history, cooldowns, leader tracking, Evil Star locks, donation history, and star/status tables. Players start a fresh season.
            </p>
            <button
              onClick={handleReset}
              disabled={loading}
